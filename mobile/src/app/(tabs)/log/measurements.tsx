...
//
// The view itself was rebuilt the same evening to her written spec - see
// measurements-view.tsx. The three mockup variants and the ?variant= switch
// that served them are gone: she chose "variant one ... with the Today rows
// approach", which is what is built.
//
