...
export default function TechnicalScreen() {
  ...
  // This screen's Continue was always enabled - it explains rather than asks -
  // so it stays that way rather than acquiring a gate it never had.
  useOnboardingAction({
    label: 'Continue',
    enabled: true,
