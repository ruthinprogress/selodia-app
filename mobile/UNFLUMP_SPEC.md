...
Targets are overrideable (like protein) and recompute as BMR/TDEE and bodyweight update. **Open work — the combination logic is decided (below) but the calc is not yet wired/built:** the calorie figures shown in the mockups (e.g. 1,700 kcal) are illustrative placeholders standing in for the real computed target until the calc lands.
